...
| closed | DB에 데이터 불러오기 2 (검색내용 불러오기)                        | -        |
| open   | 시각화 HTML 만들기 1,2 (migration:이동)                   | 2022-12-15 |
| open   | 시각화 페이지 URL 전달하는 API 만들기 (route)                  | 2022-12-15 |
| open   | flask과 springboot 연동                              | 2022-12-15   |
| open   | -                                                 | -        |
